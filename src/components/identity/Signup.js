    ...
    handleSubmit = (event: Event) => {
        ...
        if (!login.length || !lastname.length || !firstname.length || !password.length || (confirmPassword !== password)) {
            ...
            signup(login, firstname, lastname, password)
                .then(result => {
                    this.setState({registrationInProcess:false, redirectToReferrer: true, error: null});
                })
                .catch(error => this.setState({error, registrationInProcess:false}));
        }
    };

    render() {
        const {redirectToReferrer, error, loginError, firstNameError, lastNameError, passwordError,
            passwordConfirmError, needsFirstNameReminder, needsLastNameReminder, needsLoginReminder,
            needsPasswordReminder, needsConfirmPasswordReminder, registrationInProcess} = this.state;
                                ...
                                <div className="row">
                                    <div className="column">
                                        ...
                                        <div className="field">
                                            ...
                                            {firstNameError &&
                                            <div
                                                className={"ui pointing basic label " + (needsFirstNameReminder ? "red" : "")}>
                                ...
                                <div className="row">
                                    <div className="column">
                                        <div className="field">
                                            ...
                                            {lastNameError &&
                                            <div
                                                className={"ui pointing basic label " + (needsLastNameReminder ? "red" : "")}>
                                ...
                                <div className="row">
                                    <div className="column">
                                        <div className="field">
                                            ...
                                            {loginError &&
                                            <div
                                                className={"ui pointing basic label " + (needsLoginReminder ? "red" : "")}>
                                                {loginError.message}
                                            </div>
                                            }
                                        </div>
                                ...
                                <div className="row">
                                    <div className="column">
                                        <div className="field">
                                            ...
                                            {passwordError &&
                                            <div
                                                className={"ui pointing basic label " + (needsPasswordReminder ? "red" : "")}>
                                ...
                                <div className="row">
                                    <div className="column">
                                        <div className="field">
                                            ...
                                            <div
                                                className={"ui pointing basic label " + (needsConfirmPasswordReminder ? "red" : "")}>
